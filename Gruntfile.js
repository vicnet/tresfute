...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        amberc: {
            ...
            all: {
                src: [
                    'src/TresFute.st', 'src/TresFute.st', // list all sources in dependency order
                    'src/TresFute-Tests.st' // list all tests in dependency order
                ],
                amd_namespace: 'amber-tresfute',
